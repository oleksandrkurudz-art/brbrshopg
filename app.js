(() => {
  ...
  const services = [
    { id: "haircut", title: "Стрижка", category: "hair", durationMin: 45, price: 400 },
    { id: "beard", title: "Стрижка бороди", category: "beard", durationMin: 40, price: 350 },
    { id: "clipper", title: "Стрижка машинкою", category: "hair", durationMin: 35, price: 350 },
    { id: "long-hair", title: "Подовжена стрижка", category: "hair", durationMin: 60, price: 450 },
    { id: "royal-shave", title: "Королівське гоління", category: "beard", durationMin: 40, price: 300 },
    { id: "shaver", title: "Гоління шейвером", category: "beard", durationMin: 30, price: 250 },
    { id: "kids", title: "Дитяча стрижка", category: "add", durationMin: 40, price: 350 },
    { id: "combo", title: "Стрижка + борода", category: "combo", durationMin: 75, price: 700 },
    { id: "combo-clipper", title: "Стрижка машинкою + борода", category: "combo", durationMin: 70, price: 650 },
    { id: "full", title: "Повний фарш", category: "combo", durationMin: 90, price: 900 },
  ];
  ...
  function renderDatetime() {
    ...
    screens.datetime.innerHTML = `
      <article class="card summary-item">
        <strong>Барбер:</strong> ${barber?.name || "-"}
      </article>
      <div class="day-row">
        ${days
          .map(
            (day) => `
            <button class="slot ${day.iso === state.dateISO ? "active" : ""}" type="button" data-day="${day.iso}">
              ${day.weekday}
  ...
  function renderConfirm() {
    ...
    screens.confirm.innerHTML = `
      <div class="summary-grid">
        ...
        <article class="card summary-item">
          <strong>Послуга:</strong> ${service?.title || "-"}<br />
          <strong>Ціна:</strong> ${service ? formatMoney(service.price) : "-"}
        </article>
        <article class="card summary-item">
  ...
  function submitBooking() {
    ...
    if (!phone) {
      if (errorNode) errorNode.textContent = "Вкажіть номер у форматі +380...";
      return;
    }
